        ...
        <div class="align-items-center d-flex h-100">
            <div class="card-body">
                ...
                <div class="auth-brand text-center text-lg-start">
                    <a href="{{ asset('/') }}" class="logo-dark">
                        <span><img src="{{ asset('/') }}admin/assets/images/logo-dark.png" alt="" height="18"></span>
                    </a>
                    <a href="{{ asset('/') }}" class="logo-light">
                        <span><img src="{{ asset('/') }}admin/{{ asset('/') }}admin/assets/images/logo.png" alt="" height="18"></span>
                    </a>
                </div>
...
<!-- bundle -->
<script src="{{ asset('/') }}admin/{{ asset('/') }}admin/assets/js/vendor.min.js"></script>
<script src="{{ asset('/') }}admin/{{ asset('/') }}admin/assets/js/app.min.js"></script>
